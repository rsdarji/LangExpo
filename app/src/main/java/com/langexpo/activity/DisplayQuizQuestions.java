...
public class DisplayQuizQuestions extends AppCompatActivity {
    ...
    public long quizId = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_quiz_questions);

        myToolbar = (Toolbar) findViewById(R.id.quiz_question_container_toolbar);
        ...
        questionProgressBar = (ProgressBar) findViewById(R.id.quiz_question_progress);
    ...
    private void getIncomingIntent() {
        if (getIntent().hasExtra("quizId") &&
                getIntent().hasExtra("quizName") &&
                getIntent().hasExtra("userLevel") &&
                getIntent().hasExtra("levelIds") ) {

            String levelIds = getIntent().getStringExtra("levelIds");
            String[] levelIdArray = levelIds.split(",");
            quizId = getIntent().getLongExtra("quizId",0);
            if(levelIdArray.length!=0){
                new gelAllQuizQuestionIdsByCourseLevel(DisplayQuizQuestions.this, levelIds).execute();
            }
        }
    }

    private class gelAllQuizQuestionIdsByCourseLevel extends AsyncTask<Void, Void, String> {
        private ProgressDialog progressBar;
        private String levelIds;


        public gelAllQuizQuestionIdsByCourseLevel(Activity activity, String levelIds){
        ...
        protected String doInBackground(Void... voids) {
            ...
            String methodName = "getAllQuizQuestionIdsByCourseLevel";
            ...
            try {
                String urlParameters  = "levelIds="+levelIds;
                ...
                if(e instanceof ConnectException){
                    ...
                    LangExpoAlertDialog alertDialog =
                            new LangExpoAlertDialog(DisplayQuizQuestions.this,
                                    DisplayQuizQuestions.this);
        ...
        protected void onPostExecute(String result) {
            ...
            System.out.println("getAllQuizQuestionIdsByCourseLevel: "+result);
            try {
                ...
                if(loginResponse.length()!=0 &&
                    ...
                    if(totalQuestions!=0){
                        nextQuestion(questionIdsList, true);
                    }
                    progressBar.dismiss();
                    ...
                    Toast toast = Toast.makeText(DisplayQuizQuestions.this,
    ...
    public void nextQuestion(List<Long> questionIdList, boolean quiz){
        try{
            ...
            LangExpoAlertDialog alertDialog =
                    new LangExpoAlertDialog(DisplayQuizQuestions.this, DisplayQuizQuestions.this);
        ...
        if(questionIdList.isEmpty()){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.MyDialogTheme)
                    ...
                    .setMessage("Congratulations! you have completed a Quiz.\n" +
                            "your score is \nCorrect: "+correctCount+"\nIncorrect:"+incorrectCount)
                    .setIconAttribute(android.R.attr.alertDialogIcon)
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {

                        public void onClick(DialogInterface dialog, int whichButton) {
                            /*Toast.makeText(DisplayQuizQuestions.this,
                                    String.valueOf(levelId), Toast.LENGTH_SHORT).show();*/
                            Intent intent = new Intent(DisplayQuizQuestions.this, UserQuizList.class);
                            startActivity(intent);
                            new AddUserProgressAsyncTask(DisplayQuizQuestions.this,
                                    0, quizId, correctCount,
            ...
            new GetQuestionDetail(DisplayQuizQuestions.this,
            ...
            try {
                ...
                if(loginResponse.length()!=0 &&
                    ...
                    if(questionList.size()!=0){
                        loadFragmentWithQuestion(questionList.get(0), questionIdList, true);
                    }
                    ...
                    Toast toast = Toast
                            .makeText(DisplayQuizQuestions.this,
                                    loginResponse.get("message").toString(),Toast.LENGTH_LONG);
                    progressBar.dismiss();
                    toast.show();
                }
