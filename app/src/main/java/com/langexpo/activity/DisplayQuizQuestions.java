    ...
    private void getIncomingIntent() {
        if (getIntent().hasExtra("quizId") &&
            ...
            if(levelIdArray.length!=0){
                new gelAllQuizQuestionByCourseLevel(DisplayQuizQuestions.this, levelIds).execute();
            }
        }
    }

    private class gelAllQuizQuestionByCourseLevel extends AsyncTask<Void, Void, String> {
        private ProgressDialog progressBar;
        private String levelIds;


        public gelAllQuizQuestionByCourseLevel(Activity activity, String levelIds){
        ...
        protected String doInBackground(Void... voids) {
            ...
            String methodName = "featchAllQuizQuestionsByCourseLevel";
        ...
        protected void onPostExecute(String result) {
            ...
            System.out.println("featchAllQuizQuestionsByCourseLevel: "+result);
            try {
                ...
                if(loginResponse.length()!=0 &&
                    ...
                    if(totalQuestions!=0){
                        nextQuestion(questionList,true);
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.MyDialogTheme)
                    ...
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            new AddUserProgressAsyncTask(DisplayQuizQuestions.this, 0, quizId, correctCount,
