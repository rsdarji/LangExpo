...
public class UserProgressListAdapter extends RecyclerView.Adapter<UserProgressListAdapter.DailGoalViewHolder> {
    ...
    public UserProgressListAdapter(Context mCtx, List<Goal> goalList) {
        this.mCtx = mCtx;
